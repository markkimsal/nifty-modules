...
Cgn::loadModLibrary("Openid::Openid_Message");
Cgn::loadModLibrary("Openid::Openid_HMAC");
Cgn::loadModLibrary("Openid::Openid_Association");
Cgn::loadModLibrary("Openid::Openid_CryptUtil");
Cgn::loadModLibrary("Openid::Openid_DiffieHellman");
Cgn::loadModLibrary("Openid::Openid_KVForm");
Cgn::loadModLibrary("Openid::Openid_Nonce");
Cgn::loadModLibrary("Openid::Openid_Discover");
Cgn::loadModLibrary("Openid::Openid_URINorm");
Cgn::loadModLibrary("Openid::Yadis_Manager");
Cgn::loadModLibrary("Openid::Yadis_XRI");
